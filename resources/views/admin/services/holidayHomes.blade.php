            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Holiday Homes</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Holiday Homes Service </h3>
                        </div>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form id="quickForm" action="{{ route('storeHolidayHomesService') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card card-primary">
                        <table class="table" id="mytable">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('removeHolidayHomesService',['id' => encrypt($asset->id)])}}"><button class="btn btn-primary">Delete</button></a></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
